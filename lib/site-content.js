...
export const projects = [
    {
        title: "VaultDeck",
        featured: true,
        featuredTagline: "Private Android vault with encrypted on-device storage",
        description:
            "Offline-first Android vault for card details with biometric/PIN unlock and clipboard auto-clear. No analytics or cloud sync.",
        technologies: ["React Native", "Expo", "TypeScript", "Zustand", "AES-256-GCM"],
        company: "Hyperati Labs",
        timeline: "2025 – Present",
        links: [
            {
                label: "Google Play",
                href: "https://play.google.com/store/apps/details?id=com.hyperati.labs.vaultdeck",
            },
            { label: "Source", href: "https://github.com/Hyperati-Labs/vaultdeck" },
        ],
    },
    {
        title: "Torrin",
        featured: true,
        featuredTagline: "Cross-platform desktop torrent client built with Qt 6",
        description:
            "Open-source BitTorrent client for macOS, Windows, and Linux. Qt 6 Quick UI on libtorrent 2.x, with no ads or telemetry.",
        technologies: ["C++20", "Qt 6", "QML", "libtorrent", "CMake"],
        company: "Open Source",
        timeline: "2025 – Present",
        links: [
            { label: "Source", href: "https://github.com/dineshkn-dev/torrin" },
            { label: "Website", href: "https://dineshkn-dev.github.io/torrin/" },
        ],
    },
    {
...
export const homeBrief = {
    eyebrow: "Senior backend engineer",
    headline: "I build backend systems that stay calm as products grow.",
    subline:
        "API-first platforms, cloud delivery, and production workflows shaped for teams that need reliability without ceremony.",
};
