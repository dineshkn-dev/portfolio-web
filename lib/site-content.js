...
export const projects = [
    {
        title: "VaultDeck",
        featured: true,
        cockpitTagline: "Offline Android vault — encrypted, private, on Play Store",
        description:
            "Offline-first Android vault for card details — encrypted on-device storage, biometric/PIN unlock, and clipboard auto-clear. No analytics or cloud sync.",
    ...
    },
    {
        title: "Torrin",
        featured: true,
        cockpitTagline: "Desktop torrent client — Qt 6, no ads, open source",
        description:
            "Open-source BitTorrent client for macOS, Windows, and Linux — Qt 6 Quick UI on libtorrent 2.x. No ads or telemetry; signed builds with magnet and .torrent support.",
